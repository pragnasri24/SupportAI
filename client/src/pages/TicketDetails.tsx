...
function TicketDetails() {
  ...
  const handleCommentSubmit =
    async (
      ...
      if (!storedUserValue) {
        setCommentError(
          "Please log in again before sending a reply."
        );
      ...
      <div className="ticket-details-container">
        ...
        <section className="ticket-details-card">
          <div className="ticket-details-header">
            <div>
              <p className="ticket-details-label">
                Support ticket
              </p>
          ...
          {!isEditing ? (
            <>
              ...
              <section className="ticket-conversation-section">
                ...
                {commentError && (
                  <div className="ticket-comment-error">
                    {
                      commentError
                    }
                  </div>
                ...
                <div className="ticket-comment-list">
                  {commentsLoading ? (
                    <p className="ticket-comment-empty">
                      Loading
                      conversation...
                    </p>
                  ) : comments.length ===
                    ...
                    comments.map(
                      (
                        ...
                        >
                          <div
                            className="ticket-comment-avatar"
                            aria-hidden="true"
                          >
                            {comment.user.name
                              .trim()
                ...
                >
                  <label htmlFor="ticket-comment-message">
                    Write a
                    reply
                  </label>
